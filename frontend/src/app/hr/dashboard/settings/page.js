import CompanyAndProfileEdit from '@/components/hr/CompanyAndProfileEdit'
        ...
        <div className="flex gap-5">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-[#4c599a] dark:text-[#a1a7c5] font-normal">
              Manage your company preferences and personal profile information
            </span>
          </div>
        </div>
        {/* company and profile form */}
        <CompanyAndProfileEdit />
